...
#ifndef __SWATCH_DUMMY_DUMMYPROCESSOR7_HPP__
#define __SWATCH_DUMMY_DUMMYPROCESSOR7_HPP__
...
class DummyProcessor7 : public processor::Processor {
public:
  DummyProcessor7(const swatch::core::AbstractStub& aStub);
  virtual ~DummyProcessor7();
...
#endif /* SWATCH_DUMMY_DUMMYPROCESSOR7_HPP */
