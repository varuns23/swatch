...
//  std::deque<CTP7Processor*> lD7ps;
//  std::deque<CicadaProcessor*> lD7ps;
//  for(swatch::processor::Processor* lP : getProcessors()) {
//    if ( DummyProcessor* lDp = dynamic_cast<DummyProcessor*>(lP) ) lDps.push_back(lDp);
//    else if ( CTP7Processor* lD7p = dynamic_cast<CTP7Processor*>(lP) ) lD7ps.push_back(lD7p);
//    else if ( CicadaProcessor* lD7p = dynamic_cast<CicadaProcessor*>(lP) ) lD7ps.push_back(lD7p);
//  }
...
//      .add(lDps, ProcFSM_t::kStateInitial, ProcFSM_t::kTrSetup)
//      .add(lD7ps, ProcFSM_t::kStateInitial, ProcFSM_t::kTrSetup)
